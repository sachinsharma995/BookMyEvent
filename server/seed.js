...
const users = [
  ...
  {
    name: "Demo User",
    email: "user@BookMyEvent.com",
    password: "password123",
    role: "user",
  },
  {
    name: "Alice Smith",
    email: "alice@BookMyEvent.com",
    password: "password123",
    role: "user",
  },
  {
    name: "Bob Johnson",
    email: "bob@BookMyEvent.com",
    password: "password123",
    role: "user",
  },
  {
    name: "Charlie Dave",
    email: "charlie@BookMyEvent.com",
    password: "password123",
    role: "user",
  },
  {
    name: "Diana Prince",
    email: "diana@BookMyEvent.com",
    password: "password123",
    role: "user",
  },
  {
    name: "Ethan Hunt",
    email: "ethan@BookMyEvent.com",
    password: "password123",
    role: "user",
  },
  {
    name: "Fiona Gallagher",
    email: "fiona@BookMyEvent.com",
    password: "password123",
    role: "user",
  },
  {
    name: "George Miller",
    email: "george@BookMyEvent.com",
    password: "password123",
    role: "user",
  },
  {
    name: "Hannah Montana",
    email: "hannah@BookMyEvent.com",
    password: "password123",
    role: "user",
  },
];
...
const seedDatabase = async () => {
  try {
    await mongoose.connect(
      process.env.MONGO_URI || "mongodb://localhost:27017/BookMyEvent",
    );
    ...
    console.log("-------------------------------------------");
    console.log("Admin Email: admin@BookMyEvent.com");
    console.log("User Email:  user@BookMyEvent.com");
